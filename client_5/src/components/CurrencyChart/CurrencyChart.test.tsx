...
test('отображает кнопки всех периодов', () => {
  render(<CurrencyChart period={3} data={[]} isLoading={false} error={null} onPeriodChange={() => {}} />);
...
test('отображает график', () => {
  render(<CurrencyChart period={3} data={mockData} isLoading={false} error={null} onPeriodChange={() => {}} />);
